        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chats_Users_InvitedUserId",
                        column: x => x.InvitedUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Chats_Users_InvitingUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Met = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    InvitingUserId = table.Column<int>(type: "integer", nullable: false),
                    InvitedUserId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_Users_InvitedUserId",
                        column: x => x.InvitedUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chats_InvitedUserId",
                table: "Chats",
                column: "InvitedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Chats_InvitingUserId",
                table: "Chats",
                column: "InvitingUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Contacts_InvitedUserId",
                table: "Contacts",
                column: "InvitedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Contacts_InvitingUserId",
                table: "Contacts",
                column: "InvitingUserId");
